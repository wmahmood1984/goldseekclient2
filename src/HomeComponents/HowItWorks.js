    ...
    return (
        <div style={{margin:"200px"}}>
            ...
            <div style={{border:'solid green 1px', margin:'10px 50px'}}>
                ...
                <p>Users can SELL all or a portion of their credits anytime they choose.After they sell they can instantly withdraw to their Metamask Walletand the funds are deposited at the real time BNB value of their credits instantly!</p><br/>            
            </div>
            ...
            <div style={{border:'solid green 1px', margin:'10px 50px'}}>
                ...
                <ol>
                    ...
                    <li>As mebers hold their funds in the contract they still benefit from the increase in value of BNB. As BNB goes up in price so does the value of all the credits they have in the system when they exchange credits back to BNB!</li>
