    ...
    return (
        <div>
            ...
            <div style={{display:"flex"}}>
                ...
                <div style={{display:"flex"}}>
                <span>
                  <h2>${dividendBalance<0.009? (dividendBalance/1000000000000000000*props.price).toFixed(2):0 }</h2><br/>
                  <p>Your Dividend Earnings Value: {dividendBalance<0.009? (dividendBalance/1000000000000000000).toFixed(4) :0 } BNB</p>
